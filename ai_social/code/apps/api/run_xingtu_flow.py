...
def load_config(args: argparse.Namespace) -> XingtuLiveRunConfig:
    ...
    if storage_state:
        payload["storage_state_path"] = settings.resolve_storage_state_path(storage_state)
    elif "storage_state_path" in payload:
        payload["storage_state_path"] = settings.resolve_storage_state_path(str(payload["storage_state_path"]))
    elif settings.default_xingtu_storage_state.exists():
        payload["storage_state_path"] = settings.default_xingtu_storage_state
